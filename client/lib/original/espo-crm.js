...
define("modules/crm/views/task/record/list", ["exports", "views/record/list", "ui"], function (_exports, _list, _ui) {
  "use strict";
  ...
  class _default extends _list.default {
    ...
    actionSetCompleted(data) {
      ...
      _ui.default.notify(this.translate('saving', 'messages'));
      model.save({
        status: status
      }, {
        patch: true
...
define("modules/crm/views/task/record/detail", ["exports", "views/record/detail"], function (_exports, _detail) {
  "use strict";
...
define("modules/crm/handlers/task/menu", ["exports", "action-handler", "di", "metadata", "ui"], function (_exports, _actionHandler, _di, _metadata, _ui) {
  "use strict";
  ...
  class TaskMenuHandler extends _actionHandler.default {
    ...
    constructor(view) {
      super(view), _init_extra_metadata(this);

      /** @var string[]*/
      const completedStatusList = this.metadata.get(`scopes.Task.completedStatusList`, []);
      this.historyStatusList = [...completedStatusList, ...this.metadata.get(`scopes.Task.canceledStatusList`, [])];
      this.completedStatusValue = completedStatusList[0] ?? null;
    }
    async complete() {
      const model = this.view.model;
      _ui.default.notifyWait();
      await model.save({
        status: this.completedStatusValue
      }, {
        patch: true
      });
      _ui.default.success(this.view.getLanguage().translateOption('Completed', 'status', 'Task'));
    }
    ...
    static #_ = _staticBlock = () => [_init_metadata, _init_extra_metadata] = _applyDecs(this, [], [[(0, _di.inject)(_metadata.default), 0, "metadata"]], 0, void 0, _actionHandler.default).e;
  }
  _exports.default = TaskMenuHandler;
  _staticBlock();
});

define("modules/crm/handlers/task/detail-actions", ["exports", "action-handler", "di", "metadata", "ui"], function (_exports, _actionHandler, _di, _metadata, _ui) {
  "use strict";
